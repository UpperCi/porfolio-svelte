...
<div class="section">
  ...
  <ProjectCard image="missmatch.png" alt="Color wheel with a face and a bow. Text saying MissMatch.">
    ...
    <br>
    <br>
    <em>MissMatch is a WordPress plug-in to make your site more accessible. It looks at the colors used on your site and transforms them to increase the contrast, taking into account the WCAG.</em>
    </p>
  </ProjectCard>
